...
4. **Machine Types:** You can change the machine type of your codespace to have more CPU cores and RAM if your project requires more compute power. Click on the Codespace settings to upgrade your machine type (e.g., from 2-core to 4-core, 8-core, or 16-core).
